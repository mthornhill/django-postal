...
POSTAL_ADDRESS_FIRSTNAME = getattr(settings, "POSTAL_ADDRESS_FIRSTNAME", (_(u"First name"), False))
POSTAL_ADDRESS_LASTNAME = getattr(settings, "POSTAL_ADDRESS_LASTNAME", (_(u"Last name"), False))
